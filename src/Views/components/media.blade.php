	...
	<div class="modal-dialog modal-lg modal_fullwidth" role="document">
		<div class="modal-content">
						...
						<div class="media_left_upload">
							<div class="media_upload" id="drag_drop_upload">
								<form action="" method="POST" class="dropzone" id="dropzone_form" enctype="multipart/form-data">
									...
									<button type="button" class="btn btn-secondary" id="btn_select_files">Thả hoặc chọn tệp để tải lên</button>
								</form>
							</div>
						</div>
						...
						<div class="media_left_content">
							<div class="media_show">
								...
								<div class="load_more_media">
									<a href="javascript:void(0);">Tải thêm 50 items</a>
									<img src="{{ asset('contents/images/loading.gif') }}" alt="loading">
								</div>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="insert_media" disabled="disabled">Chọn media</button>
			</div>
		</div>
	</div>
</div>
