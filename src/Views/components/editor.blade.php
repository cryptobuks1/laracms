<div class="ninex_editor_area">
	<textarea class="ninex_editor" name="{{ $name }}">{{ $content }}</textarea>
</div>
<script type="text/javascript" src="{{ asset('/contents/tinymce/tinymce.min.js') }}"></script>
<script type="text/javascript">
	tinymce.init({
		selector: 'textarea.ninex_editor',
		height: 350,
		theme: 'modern',
		...
		toolbar1: "ninexmedia formatselect bold italic underline strikethrough bullist numlist alignleft aligncenter alignright alignjustify code preview fullscreen expand",
		...
		content_css: [
			base_url + '/contents/css/tinymce.css'
		]
	});
</script>